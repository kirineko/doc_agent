    ...
    pub fn default_tools() -> Self {
        Self {
            tools: vec![
                ...
                crate::tools::markdown_html::markdown_to_html_tool(),
                crate::tools::markdown_html::markdown_list_templates_tool(),
                crate::tools::markdown_html::markdown_read_template_tool(),
